...
$product_id = isset($_REQUEST['product_id']) && $_REQUEST['product_id'] > 0 ? $_REQUEST['product_id'] : 25675196; // если с ленда ничего не передается, можно указать product_id здесь
