...
$product_id = 24164149; // если айдишник продукта с ленда не передается
...
$idticket = isset($_REQUEST['idticket']) ? $_REQUEST['idticket'] : 0;
...
$post_fields = array(
    ...
    'discount' => $promocode,
    "callbackSuccess" => "https://synergyhealthyfood.ru/payment.php?productId=".$product_id,
    "callbackFail" => "https://synergyhealthyfood.ru/fail.php",
    "sourceUrl" => "https://synergyhealthyfood.ru/",
);
if(intval($idticket)>0) {
    $post_fields["comment"] = $idticket;
}
