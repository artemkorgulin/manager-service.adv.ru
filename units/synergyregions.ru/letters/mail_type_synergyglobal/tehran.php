...
if ( $_REQUEST['lang'] == 'en' ) {
	...
	if ( $intellectmoney_link ) {
		$intellectmoney_str = "<p>Оплатить билет на&nbsp;Форум в&nbsp;Тегеране вы&nbsp;можете, <a href='{$intellectmoney_link}' target='_blank'>пройдя по&nbsp;ссылке</a>.</p>";
	}

	$body = "
	<h3>{$lead->name}, поздравляем!</h3>
	<p>Вы&nbsp;зарегистрировались на&nbsp;Synergy Global Forum Tehran. Форум состоится 20-21&nbsp;февраля 2017 года в&nbsp;столице Ирана&nbsp;&mdash; Тегеране, в&nbsp;здании Центральной Телебашни.</p>
