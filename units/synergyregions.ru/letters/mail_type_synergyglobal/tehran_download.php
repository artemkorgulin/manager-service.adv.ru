...
if ( $_REQUEST['lang'] == 'en' ) {
	...
	$body = "
	<h3>Добрый день!</h3>
	<p>Вы&nbsp;оставляли заявку на&nbsp;получение программы главного бизнес-события года Synergy Global Forum Tehran 2017. Скачать программу вы&nbsp;можете, <a href='{$program_file}' target='_blank'>пройдя по&nbsp;ссылке.</a></p>
	<p>Успейте зарегистрироваться на&nbsp;Synergy Global Forum Tehran 2017 и&nbsp;станьте частью нового бизнес-сообщества! 20-21 февраля вас ждут выступления ведущих спикеров.</p>
