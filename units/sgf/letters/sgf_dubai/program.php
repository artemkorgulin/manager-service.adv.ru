...
if ( $_REQUEST['lang'] == 'en' ) {
	$body = "
	<h3>Hello!</h3>
	<p>You have left a&nbsp;request to&nbsp;get the Synergy Global Forum Dubai 2017&nbsp;program. You can download the program <a href='{$program_file}' target='_blank'>by&nbsp;clicking on&nbsp;the link.</a></p>
	<p>Have time to&nbsp;register for Synergy Global Forum Dubai 2017 and become part of&nbsp;a&nbsp;new business community!</p>
