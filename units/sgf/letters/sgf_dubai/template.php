...
<div style='font-family: Arial, Helvetica, sans-serif; color:#000; font-size:15px;'>
	<div style='margin: 0 auto; max-width: 560px; padding: 10px 20px;'>
		<a href='http://{$template_site}?utm_source=tranzmail-sgf_dubai' title='Перейти на сайт Школы Бизнеса'><img src='http://synergyglobal.ru/dubai/ru/img/logo-blue.png' alt=''></a>
	</div>
	<div style='margin: 0 auto; max-width: 560px; padding: 20px; background: #FAFAFA; border:1px solid #D0D0D0; border-radius:6px;'>
		...
		<p style='color:#505050;'><i>{$template_soon} <br><a target='_blank' style='color:#505050;' href='http://{$template_site}?utm_source=tranzmail-sgf_dubai'>{$template_team}</a><br>
			<a target='_blank' style='color:#505050;' href='http://{$template_site}?utm_source=tranzmail-sgf_dubai'>{$template_site}</a><br>
