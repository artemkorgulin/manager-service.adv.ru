<?php
$template_soon = "";
$template_team = isset($template_team) ? $template_team : "С&nbsp;уважением, Школа Бизнеса «Синергия»";
$template_phone = "тел. ";
...
<div style='font-family: Arial, Helvetica, sans-serif; color:#000; font-size:15px;'>
	<div style='margin: 0 auto; max-width: 560px; padding: 10px 20px;'>
		<a href='http://synergy.ru?utm_source=tranzmail-sgf_ny' title='Перейти на сайт Университета'><img src='https://synergy.ru/assets/upload/logos/sgf.jpg' alt=''></a>
	</div>
