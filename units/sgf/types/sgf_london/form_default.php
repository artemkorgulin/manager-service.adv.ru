...
$config['mail']['smtp']['user']['subject'] = "Ваша регистрация на Synergy Global Forum Лондон 2018";
...
if ( $_REQUEST['lang'] == 'en' ) {
	...
	$config['mail']['smtp']['user']['subject'] = "Your registration for Synergy Global Forum London 2018";
}
...
if ( $lead->land == 'sgf2017-lite-ru' ) {
	...
	<div class="send-success">
		<p>
			Спасибо! Ваша заявка отправлена. В&nbsp;ближайшее время наш менеджер свяжется с&nbsp;вами и&nbsp;подробно расскажет о&nbsp;Synergy Global Forum Лондон 2018.
		</p>
	</div>
	';
}
elseif ( $lead->land == 'sgf2017-lite-en' ) {
	...
	<div class="send-success">
		<p>
			Thank you! Your request has been sent. We&rsquo;ll call you back and tell mоre about Synergy Global Forum London 2018.
		</p>
	</div>
	';
}
...
$config['mail']['smtp']['user']['message'] = include_once UNIT_DIR.'/letters/sgf_london/default.php';
