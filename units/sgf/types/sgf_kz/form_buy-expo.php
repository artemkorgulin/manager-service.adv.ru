...
$config['mail']['smtp']['user']['subject'] = "Размещение стенда на Synergy Global Forum 2017 в Алматы";

$config['mail']['smtp']['user']['message'] = include_once UNIT_DIR.'/letters/sgf_kz/buy-expo.php';
