...
$config['mail']['smtp']['user']['message'] = include_once UNIT_DIR.'/letters/sgf_ny/accreditation-press.php';

$config['ignore']['send_to_cc'] = true;
$config['mail']['smtp']['cc']['emails'] = array(array('msimonson@synergyglobal.com'));
$config['mail']['smtp']['cc']['subject'] = 'Request Press Accreditation';
$message = "
<p>
