...
$ticketsCount = isset($_REQUEST['food-tickets_count']) && $_REQUEST['food-tickets_count'] > 0 ? $_REQUEST['food-tickets_count'] * 1 : 1;
...
if (true) {
	if (!isset($_REQUEST['payment-type']) && !isset($_REQUEST['company'])) {
		...
		<input name="food-tickets_count" value="' . $ticketsCount . '" type="hidden">
