...
$config['user']['sendsuccess'] = '
		...
		<script>
			setTimeout(function(){
				...
				$("body").append("<iframe src=\"https://payment.1001tickets.org/?method=getPdfWithUrl&orient=landscape&url=https://astanaforum.info/generate.php?name='.$fullname.'\" style=\"border:0;width:0;height:0;\"></iframe>");
