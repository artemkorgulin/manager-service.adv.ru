...
if ($categoryName == "SPECIAL" || $categoryName == "СПЕЦИАЛЬНОЕ ПРЕДЛОЖЕНИЕ") {
	$priceVariant = 88;
	$product_id = 5505164;
}
// ТЕСТЫ ТУТ!
...
function createOrderFood( $lead, $ticketsCount, $priceVariant, $promocode, $category, $invoice, $company, $productId ){
	...
	$seatsRand = getSeatsRandom($allticketscount, $category, 61);
	...
	$responseApi = cURLsend('https://api.1001tickets.org/events/61', $postData);
