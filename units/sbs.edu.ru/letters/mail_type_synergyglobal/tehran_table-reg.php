...
if ( $_REQUEST['lang'] == 'en' ) {
	...
	$body = "
	<h3>{$lead->name}!</h3>
	<p>Вы&nbsp;успешно зарегистрировались на&nbsp;участие в&nbsp;круглом столе &laquo;$tehran_table_name&raquo;. Желаем вам плодотворной работы и&nbsp;активного нетворкинга в&nbsp;рамках Российско-иранского делового форума.</p>";
}
