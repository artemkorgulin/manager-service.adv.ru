...
<div style="font-family: Arial, Helvetica, sans-serif; color:#000; font-size:15px;">
	...
	<div style="margin: 0 auto; width: 540px; padding: 30px; background: #FAFAFA; border:1px solid #D0D0D0; border-radius:6px;">
		...
		<p>Вы&nbsp;зарегистрировались на&nbsp;бесплатный семинар <b>«{$lead->program}»</b>, который ведет эксперт <b>{$lead->speaker}</b>.</p>
		<p>Семинар состоится <b>{$lead->dater}</b> по&nbsp;адресу: м.&nbsp;«Семеновская», ул.&nbsp;Измайловский Вал, д.&nbsp;2, стр.&nbsp;1, аудитория&nbsp;611.</p>
