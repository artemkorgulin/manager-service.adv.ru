...
if($lead->land == 'synergy_resonance') {
    ...
    <div class='send-success'>
		...
		<p>{$lead->name}, вы успешно зарегистрировались на интенсив, ссылку для участия вы получите на вашу почту <b>{$lead->email}</b>.</p>
...
// Конфигуратор FormMessages
	...
	<div class='send-success'>
		<h3>Заявка успешно отправлена!</h3>
		<p>{$lead->name}, вы успешно зарегистрировались на семинар, ссылку для участия вы получите на вашу почту <b>{$lead->email}</b>.</p>
		<script>$('document').ready(function(){Hash.add('send','ok');});</script>
	</div>";
