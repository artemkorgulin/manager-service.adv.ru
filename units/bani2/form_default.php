...
{	
	...
	$config['mail']['smtp']['cc']['emails'] = array(array('baniudachi@gmail.com',  'vitaliynizhnikov@gmail.com', '79687582324@yandex.ru'));	
	$config['mail']['smtp']['cc']['subject'] = "Заявка с ленда БаняУдачи";
	...
	$config['mail']['smtp']['fromname']	= "БаняУдачи";
